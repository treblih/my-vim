...
syn keyword	cStatement	goto break return continue asm new delete
...
syn keyword	cType		int long short char void TYPE
syn keyword	cType		signed unsigned float double
if !exists("c_no_ansi") || exists("c_ansi_typedefs")
  syn keyword   cType		size_t ssize_t off_t wchar_t ptrdiff_t sig_atomic_t fpos_t
  syn keyword   cType		clock_t time_t jmp_buf FILE DIR div_t ldiv_t
  syn keyword   cType		mbstate_t wctrans_t wint_t wctype_t
  syn keyword   cType		va_list va_start va_arg va_end
endif
if !exists("c_no_c99") " ISO C99
