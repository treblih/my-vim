...
hi StatusLine   guifg=#000000 guibg=#F2710D gui=none
...
hi Number       guifg=#F2710D gui=bold

hi MatchParen   guibg=#ad7fa8 guifg=#FFFFFF
hi Comment      guifg=#F3A297 gui=italic 
hi Constant     guifg=#222F5A gui=bold
hi String       guifg=#fce94f
hi Identifier   guifg=#629fcf
hi Statement    guifg=#5DDDDC gui=bold
hi PreProc      guifg=#3D0B6B gui=bold
hi Type         guifg=#79E914 gui=bold
hi Special      guifg=#000000 gui=bold
