...
let s:C_LineEndCommColDefault = 57
...
" %d.%m.%y  %H:%M
let s:C_FormatDate						= '%d.%m.%y'
let s:C_FormatTime						= '%H:%M'
...
function! C_EscapeLine ( )
	...
	call C_InsertTemplate('comment.escape-line')
endfunction		" ---------- end of function  C_LineEndComment  ----------
"
"------------------------------------------------------------------------------
