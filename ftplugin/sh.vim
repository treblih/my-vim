...
inoremap  <buffer>  <silent>  <LocalLeader>cs      <Esc>:call BASH_GetLineEndCommCol()<CR>
 ...
 noremap  <buffer>  <silent>  <LocalLeader>cpa          :call BASH_InsertTemplate("comment.package")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>cpa     <Esc>:call BASH_InsertTemplate("comment.package")<CR>
 noremap  <buffer>  <silent>  <LocalLeader>cpr          :call BASH_InsertTemplate("comment.procedure")<CR>
inoremap  <buffer>  <silent>  <LocalLeader>cpr     <Esc>:call BASH_InsertTemplate("comment.procedure")<CR>
...
vnoremap    <buffer>  <silent>  <LocalLeader>cc    <Esc>:'<,'>call BASH_CommentToggle()<CR>j
 ...
 noremap  <buffer>  <silent>  <LocalLeader>cd      <Esc>:call BASH_InsertDateAndTime('d')<CR>
...
if !exists("g:BASH_Ctrl_j") || ( exists("g:BASH_Ctrl_j") && g:BASH_Ctrl_j != 'off' )
	nmap    <buffer>  <silent>  <C-u>   i<C-R>=BASH_JumpCtrlJ()<CR>
	imap    <buffer>  <silent>  <C-u>    <C-R>=BASH_JumpCtrlJ()<CR>
endif
