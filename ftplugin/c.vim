...
" ---------- comments menu  ------------------------------------------------
"
 noremap    <buffer>  <silent>  <LocalLeader>c\         :call C_EscapeLine()<CR>
inoremap    <buffer>  <silent>  <LocalLeader>c\    <Esc>:call C_EscapeLine()<CR>a
vnoremap    <buffer>  <silent>  <LocalLeader>c\    <Esc>:call C_MultiEscapeLine()<CR>a
...
inoremap    <buffer>  <silent>  <LocalLeader>pp   <Esc>:call C_InsertTemplate("preprocessor.pragma")<CR>
 ...
 noremap    <buffer>  <silent>  <LocalLeader>ph        :call C_InsertTemplate("preprocessor.head-file")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>ph   <Esc>:call C_InsertTemplate("preprocessor.head-file")<CR>

 noremap    <buffer>  <silent>  <LocalLeader>pr        :call C_InsertTemplate("preprocessor.head-include")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>pr   <Esc>:call C_InsertTemplate("preprocessor.head-include")<CR>
"
" ---------- idioms menu  ----------------------------------------------------
"
...
vnoremap    <buffer>  <silent>  <LocalLeader>io    <Esc>:call C_InsertTemplate("idioms.open-output-file", "v")<CR>
 ...
 noremap    <buffer>  <silent>  <LocalLeader>iva        :call C_InsertTemplate("idioms.var-args")<CR>
inoremap    <buffer>  <silent>  <LocalLeader>iva   <Esc>:call C_InsertTemplate("idioms.var-args")<CR>
